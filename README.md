...
### [Ответ](#response)
1. [Один объект](#response-one)![v1](v1.png)  `{result:{}}`
2. [Список объектов](#response-list)![v1](v1.png)  `{result:{items:[]}`
3. [Ошибки](#response-error)![v1](v1.png) `{error:{}}`

### [Запрос](#query)
__[`fields`](#fields)__ - что выбрать.
1. [По умолчанию](#fields-default)![v1](v1.png)
2. [Все свойства](#fields-all)![v1](v1.png) - `*`
3. [Выборочные свойства](#fields-map)![v1](v1.png)   - `prop1, prop2(prop3)`
4. [Свойства списка](#fields-list)![v2](v2.png) - `items(prop1), count`
5. [Исключение свойств](#fields-deny)![v2](v2.png) - `!prop1, !prop2` 
6. [Зависимость от типа объекта](#fields-namespace)![v3](v3.png) - `id, author(name, manager:rating)`
7. [Рекурсивные шаблоны](#fields-recursive)![v3](v3.png)  - `comments(text, children(^))`
...
#### `fields = prop(type1:prop1, type2:prop2)` {#fields-namespace}
